...
def RNewProduct():
    if request.method == 'POST':
        ...
        ProductType=request.form['protype']
        Unit=request.form['unit']
        Quantity=request.form['quantity']
        Unitprice=request.form['unp']
        TotalCost = request.form['tcost']
        #Image= file.filename
        ...
        insertQuery = "INSERT INTO protb VALUES ('"+ id +"','"+ ProductId +"','"+ProductType+"','" + Unit + "','" + Quantity + "','" + Unitprice + "','" + TotalCost + "')"
        insert_table = ibm_db.exec_immediate(conn, insertQuery)
